...
(lib.mainfile = function(mode,startPosition,loop) {
	...
	this.shape_11.graphics.f().s("#FFFFFF").ss(0.1,1,1).p("ABu4NIAUAAIAAADAhtYOIgUAAIAAgDACCYOIjdAAAiB4NIDdAA");
	...
	this.shape_13.graphics.f().s("#FFFFFF").ss(0.1,1,1).p("ABu4NIAUAAIAAADACCYOIjdAAAhtYOIgUAAIAAgD");
